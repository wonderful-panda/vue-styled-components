...
var _styledComponent = (function (ComponentStyle) {
  var createStyledComponent = function createStyledComponent(target, rules, propsDef) {
    var hasProps = !!propsDef;
    var componentStyle = new ComponentStyle(rules);
    var getGeneratedClassName = void 0;
    if (rules.filter(function (r) {
      return r instanceof Function;
    }).length === 0) {
      var generatedClassName = componentStyle.generateAndInjectStyles({});
      getGeneratedClassName = function getGeneratedClassName() {
        return generatedClassName;
      };
    } else {
      getGeneratedClassName = function getGeneratedClassName(props, attrs) {
        return componentStyle.generateAndInjectStyles(Object.assign({}, props, attrs));
      };
    }
    ...
    var StyledComponent = {
      ...
      render: function render(createElement, _ref) {
        ...
        var generatedClassName = getGeneratedClassName(props, data.attrs);
        if (data.staticClass) {
        ...
        var children = [];
        var slots_ = slots();
        for (var slotName in slots_) {
          var slot = slots_[slotName];
          if (slotName === 'default') {
            children.push(slot);
          } else {
        ...
        return createElement(target, data, children);
      }
    };
...
export { css, injectGlobal };export default styled;
